        ...
        while open_set:
            ...
            for neighbor_anchor, step_cost in self._graph.get_neighbors(current_anchor):
                ...
                if action and action != Action.WAIT:
                    ...
                    if not self._reservations.is_transition_free(
                        ct, nt, swept, neighbor_cells, exclude_robot=robot_id
                    ):
                        continue
                elif not self._reservations.is_pose_free(
