...
class FootprintValidator:
    ...
    def is_valid_transition(
        ...
        # 水平换列只能发生在主干道。footprint 的锚点代表其左上角，
        # 因此起点和终点锚点都必须位于主干道范围内。
        if action in (Action.LEFT, Action.RIGHT) and (
            from_anchor.y < trunk_y_threshold or to_anchor.y < trunk_y_threshold
        ):
            return False, "水平移动仅允许在主干道"
